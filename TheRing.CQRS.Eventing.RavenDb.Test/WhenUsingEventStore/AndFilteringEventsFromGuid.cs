namespace TheRing.CQRS.Eventing.RavenDb.Test.WhenUsingEventStore
{
    ...
    public class AndFilteringEventsFromGuid : WhenUsingEventStore
    {
        ...
        private IEnumerable<AbstractEvent> filteredEvents;
        private IEnumerable<AbstractEvent> filteredMaxEvents;
        private IEnumerable<AbstractEvent> filteredMinEvents;
        private IEnumerable<AbstractEvent> allEvents;
        private Guid id;
