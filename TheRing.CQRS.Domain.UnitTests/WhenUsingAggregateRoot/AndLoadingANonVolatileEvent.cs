namespace TheRing.CQRS.Domain.UnitTests.WhenUsingAggregateRoot
{
    ...
    public class AndLoadingANonVolatileEvent : WhenUsingAggregateRoot
    {
        #region Constants
        ...
        private FakeNonVolatileEvent @event;
        ...
        [Test]
        public void ThenTheAggregateShouldApllyTheEvent()
        {
            this.AggregateRoot.NonVolatileProperty.Should().Be(PropertyValue);
        }
